...
- [x] Fase 3 — Timeline Pelaksanaan (kode selesai termasuk 3 ronde revisi: flag status milestone + Gantt chart mingguan + edit-lock milestone, bidang untuk leader_bidang, dan hapus bucket default "Penetapan Susunan Kepanitiaan"; `next build`/`next lint`/`tsc --noEmit` sukses di sandbox. **Ada 2 migration SQL baru** yang belum dijalankan/diverifikasi live oleh Yolanda: `20260809000004_fase3_committee_bucket_assignment.sql` dan `20260809000005_fase3_hapus_bucket_penetapan_susunan.sql` — lihat catatan di bawah)
- [ ] Fase 4 — Bucket Tugas & Breakdown
- [ ] Fase 5 — Download/Submit Template Budgeting
- [ ] Fase 6 — Dashboard Kepanitiaan (Leader)
- [ ] Fase 7 — Notifikasi
